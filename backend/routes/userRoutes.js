...
// Tourist only routes
router.get('/wishlist', protect, restrictTo('tourist'), userController.getWishlist);
...
router.post('/claim-coupon', protect, restrictTo('tourist'), userController.claimReferralCoupon);
